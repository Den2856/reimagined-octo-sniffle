...
export default function CallToAction() {
  ...
  return (
    <motion.section
      className="relative w-full border-t-[2.5px] border-neutral-15 bg-neutral-8 text-white py-16 overflow-hidden"
      initial="hidden" whileInView="visible" viewport={{ amount: 0.3 }} variants={containerVariants}
    >
      ...
      <div className="relative z-10 mx-auto px-4 flex flex-col md:flex-row items-center justify-between">
        <motion.div className="md:w-2/3" variants={textVariants}>
          <motion.h2
            className="flex flex-col text-4xl md:text-5xl font-bold leading-tight"
            variants={textVariants}
          >
            {t('cta.heading')}
          </motion.h2>
          <motion.p className="mt-4 text-gray-100" variants={textVariants}>
            {t('cta.description')}
          </motion.p>
          <MotionLink
            to="/tours"
